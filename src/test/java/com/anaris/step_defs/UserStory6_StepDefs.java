...
import com.anaris.utilities.MyMethods;
...
public class UserStory6_StepDefs {
    ...
    // second approach by Adam to solve US3
    ...
    public void usersUploadsFileWithTheUploadFileOption() {
        BrowserUtils.waitFor(1);
        String uploadedFileName = "anaris - Copy (8).txt";
    ...
    public void userOnTheDashboardPageByUsingAnd(String arg0, String arg1) {
        Driver.getDriver().get(ConfigurationReader.getProperty("trycloud.url"));
